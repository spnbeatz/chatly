...
export const ChatWindow = () => {
    ...
    const countReaction = (type: string) => {
...
const MessageRow = ({ message }: { message: ChatMessage }) => {
    ...
    const { getSenderName, toggleReaction } = useChat();
...
<div className="flex gap-1 mt-2">
    ...
    <button onClick={() => toggleReaction(message.id, "Laugh")}>
         {countReaction("Laugh")}
    </button>

    <button onClick={() => toggleReaction(message.id, "Sad")}>
         {countReaction("Sad")}
    </button>

    <button onClick={() => toggleReaction(message.id, "Angry")}>
         {countReaction("Angry")}
    </button>
</div>